...
**Version:** 2.5 (reflects unified Lead/Deal pipeline, Product Catalog/CustomerProduct/Project tracking, RBAC enforcement, Attachments, Deal probability/lost-reason/forecast, Admin-configurable pipeline stages/lead sources, a frontend audit-log view, CSV export, lead round-robin assignment, task due-date email notifications, and server-side list pagination now built)
**Date:** 2026-08-17
