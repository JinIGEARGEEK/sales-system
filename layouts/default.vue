...
const menuList = computed(() => {
  const items: MenuItem[] = [
    ...
    { icon: 'material-symbols:person-search-outline', label: t('layout.nav.leads'), path: '/crm/leads', separator: false, roles: ['Admin', 'Sales Rep', 'Sales Manager'] },
    ...
    { icon: 'material-symbols:contacts-outline', label: t('layout.nav.contacts'), path: '/crm/contacts', separator: false, roles: ['Admin', 'Sales Rep', 'Sales Manager'] },
    { icon: 'material-symbols:sell-outline', label: t('layout.nav.tags'), path: '/crm/tags', separator: true, roles: ['Admin', 'Sales Rep', 'Sales Manager'] },
