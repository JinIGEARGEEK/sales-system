export default {
  ...
  tabs: {
    ...
    prospects: 'Prospect Stages & Sources',
  ...
  prospectStages: {
    heading: 'Prospect Stages',
    addStage: 'Add Stage',
    addTitle: 'Add Prospect Stage',
    editTitle: 'Edit Prospect Stage',
    name: 'Stage Name',
    sortOrder: 'Sort Order',
    isDisqualifiedStage: 'Counts as Disqualified',
    columns: {
      name: 'Name',
      sortOrder: 'Order',
      flags: 'Flags',
  ...
  weeklyDigest: {
    heading: 'Weekly pipeline email',
    enabledLabel: 'Email Admins and Sales Managers a weekly Overview Pipeline summary',
    help: 'Every Monday from 08:00: last week\'s new Prospects, Leads and Deals with conversion, Won, open pipeline, and what needs a question (stale Deals, slips, losses with reasons), with a link to the board.',
    smtpMissing: 'Email isn\'t configured on the server (SMTP), so nothing will be sent yet.',
    lastSent: 'Last sent {date}',
    neverSent: 'Not sent yet',
    recipients: 'Goes to: {list}',
    noRecipients: 'No active Admin or Sales Manager has an email address.',
    preview: 'Preview',
    sendTest: 'Send me a test',
    previewTitle: 'Weekly email preview',
    previewWeek: 'Covers {from} – {to}',
    testSent: 'Test email sent to {email}',
    saveSuccess: 'Weekly email setting saved',
  },
  salesQuota: {
