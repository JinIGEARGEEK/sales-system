export default {
  ...
  notificationRules: {
    ...
    help: 'กฎที่ใช้งานอยู่จะตรวจสอบ Deal, Quote หรือ Contract ที่เข้าเงื่อนไขค้างนาน/มีความเสี่ยง แล้วแจ้งเตือนเจ้าของ (หรือเจ้าของและ Sales Manager) เมื่อครบตามเกณฑ์วัน เช่น Deal ที่ยังเปิดอยู่ค้างในขั้นตอนเดิมนานเกินไป, Quote ที่ส่งแล้วใกล้ถึงวันหมดอายุ หรือ Contract ที่เป็นแบบร่าง/ส่งแล้วแต่ยังไม่มีการเซ็นสัญญา',
    addRule: 'เพิ่มกฎ',
