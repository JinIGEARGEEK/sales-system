export default {
  ...
  tabs: {
    ...
    prospects: 'ขั้นตอนและแหล่งที่มาของ Prospect',
  ...
  prospectStages: {
    ...
    addStage: 'เพิ่มขั้นตอน',
    addTitle: 'เพิ่มขั้นตอน Prospect',
    editTitle: 'แก้ไขขั้นตอน Prospect',
    name: 'ชื่อขั้นตอน',
    sortOrder: 'ลำดับ',
    isDisqualifiedStage: 'นับเป็น Disqualified',
    columns: {
      name: 'ชื่อ',
      sortOrder: 'ลำดับ',
      flags: 'สถานะพิเศษ',
  ...
  weeklyDigest: {
    ...
    enabledLabel: 'ส่งอีเมลสรุปภาพรวมไปป์ไลน์รายสัปดาห์ถึง Admin และ Sales Manager',
    help: 'ทุกวันจันทร์ตั้งแต่ 08:00 น.: Prospect, Lead และ Deal ใหม่ของสัปดาห์ที่แล้วพร้อมอัตรา conversion, Won, ไปป์ไลน์ที่เปิดอยู่ และรายการที่ควรสอบถาม (Deal ที่ค้าง ถอยหลัง หรือแพ้พร้อมเหตุผล) พร้อมลิงก์ไปยังบอร์ด',
    smtpMissing: 'ยังไม่ได้ตั้งค่าอีเมล (SMTP) บนเซิร์ฟเวอร์ จึงยังไม่มีการส่ง',
    lastSent: 'ส่งล่าสุด {date}',
    neverSent: 'ยังไม่เคยส่ง',
    recipients: 'ผู้รับ: {list}',
    noRecipients: 'ไม่มี Admin หรือ Sales Manager ที่ใช้งานอยู่และมีอีเมล',
    preview: 'ดูตัวอย่าง',
  ...
  notifications: {
    ...
    smtpNotConfigured: 'การแจ้งเตือนทางอีเมล: ยังไม่ได้ตั้งค่า SMTP — ระบบจะข้ามการส่งอีเมลแจ้งเตือนงานครบกำหนดโดยไม่แจ้งเตือน กรุณาตั้งค่า SMTP_HOST (และตัวแปร SMTP_* ที่เกี่ยวข้อง) ฝั่งเซิร์ฟเวอร์เพื่อเปิดใช้งาน',
  },
  notificationRules: {
