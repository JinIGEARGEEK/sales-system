export default {
  ...
  create: {
    ...
    industry: 'Industry',
    industryPlaceholder: 'Search or type a new industry',
    companySize: 'Company Size',
    companySizePlaceholder: 'e.g. 51-200 คน',
  ...
  detail: {
    ...
    tabs: {
      ...
      contacts: 'Contacts',
      deals: 'Deals',
      quotesContracts: 'Quotes & Contracts',
      products: 'Products',
      projects: 'Projects',
      activity: 'Activity',
      tasks: 'Tasks',
    ...
    noQuotes: 'No quotes from any of this company\'s deals yet.',
    contractsHeading: 'Contracts',
    noContracts: 'No contracts from any of this company\'s deals yet.',
    fromDeal: 'From Deal: {title}',
