export default {
  ...
  detail: {
    ...
    tabs: {
      ...
      contacts: 'ผู้ติดต่อ',
      deals: 'Deal',
      quotesContracts: 'ใบเสนอราคา & สัญญา',
      products: 'Products',
      projects: 'Projects',
      activity: 'กิจกรรม',
      tasks: 'งานติดตาม',
    ...
    quotesHeading: 'ใบเสนอราคา',
    noQuotes: 'ยังไม่มีใบเสนอราคาจาก Deal ใดของบริษัทนี้',
    contractsHeading: 'สัญญา',
    noContracts: 'ยังไม่มีสัญญาจาก Deal ใดของบริษัทนี้',
    fromDeal: 'จาก Deal: {title}',
