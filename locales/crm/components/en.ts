export default {
  ...
  addTaskModal: {
    ...
    relatesToCompanyPlaceholder: 'Search or type a new company name',
    taskTitle: 'Task',
    description: 'Description',
    priority: 'Priority',
    dueDate: 'Due Date',
  ...
  createCampaignModal: {
    ...
    description: 'Creates one follow-up task for each of the {count} selected records, grouped under a campaign.',
    modeNew: 'New campaign',
    modeExisting: 'Add to existing campaign',
    campaignName: 'Campaign name',
    campaignNamePlaceholder: 'e.g. Q3 Win-Back Outreach',
    campaignType: 'Campaign type',
    existingCampaign: 'Campaign',
    existingCampaignPlaceholder: 'Select a campaign',
    ...
    reviewSummary: 'This will create {count} follow-up tasks for these records, due by {date}, assigned to {name}.',
    cancel: 'Cancel',
    save: 'Save Campaign',
  },
