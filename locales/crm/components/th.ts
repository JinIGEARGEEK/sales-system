export default {
  ...
  confirmDeleteModal: {
    ...
    cancel: 'ยกเลิก',
    delete: 'ยืนยัน',
    trashTitle: 'ย้ายไปถังขยะ',
    trashBody: 'ต้องการย้าย "{name}" ไปถังขยะใช่หรือไม่',
    trashBodyFallback: 'ต้องการย้ายรายการนี้ไปถังขยะใช่หรือไม่',
    trashHint: 'ผู้ดูแลระบบหรือผู้จัดการฝ่ายขายสามารถกู้คืนได้จากหน้าถังขยะ',
  ...
  addTaskModal: {
    ...
    relatesToCompanyPlaceholder: 'ค้นหาหรือพิมพ์ชื่อบริษัทใหม่',
  ...
  createCampaignModal: {
    ...
    modeNew: 'แคมเปญใหม่',
    modeExisting: 'เพิ่มเข้าแคมเปญที่มีอยู่',
    campaignName: 'ชื่อแคมเปญ',
    campaignNamePlaceholder: 'เช่น แคมเปญ Win-Back ไตรมาส 3',
    campaignType: 'ประเภทแคมเปญ',
    existingCampaign: 'แคมเปญ',
    existingCampaignPlaceholder: 'เลือกแคมเปญ',
    message: 'ให้พูดอะไรกับลูกค้าเมื่อติดตาม?',
    messagePlaceholder: 'โทรถามไถ่และแนะนำบริการใหม่ของเรา',
    dueDate: 'ติดตามภายในวันที่',
    assignedTo: 'ใครเป็นคนติดต่อ',
    moreOptions: 'ตัวเลือกเพิ่มเติม',
    reviewSummary: 'ระบบจะสร้างงานติดตาม {count} รายการสำหรับรายการเหล่านี้ ครบกำหนดวันที่ {date} มอบหมายให้ {name}',
    cancel: 'ยกเลิก',
    save: 'บันทึกแคมเปญ',
  },
