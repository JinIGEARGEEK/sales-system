export default {
  ...
  create: {
    ...
    referredByTypeLabel: 'Referred By',
    referredByTypePlaceholder: 'Company or Contact',
    referredByTypeCompany: 'Company',
    referredByTypeContact: 'Contact',
    referredByLabel: 'Referring Company/Contact',
    referredByPlaceholder: 'Search existing...',
    status: 'Status',
