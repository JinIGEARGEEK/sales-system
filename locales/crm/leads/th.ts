export default {
  ...
  create: {
    ...
    referredByTypeLabel: 'ผู้แนะนำ',
    referredByTypePlaceholder: 'บริษัทหรือผู้ติดต่อ',
    referredByTypeCompany: 'บริษัท',
    referredByTypeContact: 'ผู้ติดต่อ',
    referredByLabel: 'บริษัท/ผู้ติดต่อที่แนะนำ',
    referredByPlaceholder: 'ค้นหาที่มีอยู่แล้ว...',
    status: 'สถานะ',
