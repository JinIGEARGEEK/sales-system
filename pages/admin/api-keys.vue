    ...
    <AccessGate :can-access="canAccess">
      ...
      <UCard :ui="GLASS_PANEL_UI">
        <TableData
          ...
          :per-page="perPage"
          :loading="loading"
          :empty-title="t('admin.apiKeys.index.emptyTitle')"
          :empty-description="t('admin.apiKeys.index.emptyDescription')"
          empty-icon="material-symbols:key-outline"
          :empty-action-label="t('admin.apiKeys.index.addKey')"
          @empty-action="createModalOpen = true"
