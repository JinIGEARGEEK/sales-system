<template>
  <div class="p-5">
    <div class="mb-4">
      <h2 class="text-xl font-black [-webkit-text-stroke:0.6px_currentColor]">{{ t('crm.leads.create.heading') }}</h2>
...
const duplicateLeads = computed(() => findDuplicateLeads(form.email, form.phone))
